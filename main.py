...
def main():
    ...
    if args.method == 'tim_p2':
        from TIM_p2_solver.tim_p2_runner import run_tim_p2
        ...
        run_tim_p2(cfg, shot_features, shot_labels, val_features, val_labels, test_features, test_labels,
                clip_prototypes)    
    elif args.method == 'TransCLIP':
        from baseline_vl.TransCLIP import TransCLIP_solver
